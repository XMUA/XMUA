<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TLeave.aspx.cs" Inherits="XMUA.Teacher.TLeave" %>
...
<body class="body1">
   ...
   <div style="width:300px;height:100px;position:absolute;top:10px;">
    ...
    <div class="sidenav">
        <ul class="sidenavul">
             <li><a href="TLeave1.aspx">Exist Leave Application</a></li>
            <li><a href="TLeaveApply.aspx">Leave Apply</a></li>
        </ul>
    </div>
    ...
    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" CellPadding="25" Width="1100px" DataSourceID="SqlDataSource2" ForeColor="#333333" GridLines="None" AllowPaging="True" Height="40px" PageSize="5">
