<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher/Teacher.Master" AutoEventWireup="true" CodeBehind="TLeaveApply.aspx.cs" Inherits="XMUA.Teacher.TLeaveApply" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="sidenav">
        <ul class="sidenavul">
             <li><a href="TLeave.aspx">Exist Leave Application</a></li>
